...
impl Package {
    ...
    fn get_fees(&self, cents_per_kg: i32) -> f32 {
        println!("weight: {}, cents: {}", self.weight_in_grams, cents_per_kg);
        return (self.weight_in_grams as f32  / 1000.) * cents_per_kg  as f32;
    }
}
